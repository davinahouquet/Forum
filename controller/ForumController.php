<?php
    ...
    //     public function index(){
        ...
        //          "data" => [
        //              "categories" =>  $categoryManager->findAll(["categoryName", "ASC"]) //la méthode "findAll" est une méthode générique qui provient de l'AbstractController (dont hérite chaque controller de l'application)
        //          ]
        //      ];
